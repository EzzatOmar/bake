...
It is important to Mock TPortal arguments in function if they existis.
They are meant to be replaced with a test object to remove side effects.
Sometimes it makes sense to not mock part of the TPortal.
E.g. if you can spin up an inmemory sqlite database.

## No integration tests

Never write tests integrating real resources, like db or 3rd-party endpoints